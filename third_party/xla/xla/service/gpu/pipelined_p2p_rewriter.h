...
// code to rotate SendDone and RecvDone at the end of a loop iteration to the
// beginning of the next iteration.
//
// In parcitular, a pipelined Send/Recv chain with one channel group with this
// code pattern:
//
// main:
//    recv
...
class PipelinedP2PRewriter : public HloModulePass {
 public:
  ...
  // Runs PipelinedP2PRewriter pass on computations in 'module'.
