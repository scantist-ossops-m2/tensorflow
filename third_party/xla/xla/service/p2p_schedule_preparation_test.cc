...
body {
    ...
    recv-done.0.f = (u32[2], u32[], token[]) get-tuple-element(param), index=1
    recv-data.0 = u32[2] get-tuple-element(recv-done.0.f), index=0
    recv-done.1.f = (u32[2], u32[], token[]) get-tuple-element(param), index=2
    ...
    ROOT result = (u32[], (u32[2], u32[], token[]), (u32[2], u32[], token[]),
      (u32[2], u32[], token[]), (u32[2], u32[], token[])) tuple(new_count, recv-done.0, recv-done.1, send-done.0, send-done.1)
  }
