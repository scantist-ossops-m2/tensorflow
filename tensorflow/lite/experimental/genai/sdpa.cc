...
TfLiteStatus SDPAEval(TfLiteContext* context, TfLiteNode* node) {
  ...
  if (mqa) {
    ...
    auto transpose_q2_params = TransposeParams(4, {0, 1, 3, 2});
  ...
  // permute v
  auto transpose_v_params = TransposeParams(4, {0, 2, 3, 1});
  ...
  if (mqa) {
    ...
    auto transpose_softmax_out_params = TransposeParams(4, {0, 1, 3, 2});
  ...
  // permute out
  auto transpose_out_params = TransposeParams(4, {0, 2, 1, 3});
